...
public class Java8Parser extends MyParser {
	static {
	...
	public static final int ABSTRACT = 1, ASSERT = 2, BOOLEAN = 3, BREAK = 4, BYTE = 5, CASE = 6, CATCH = 7, CHAR = 8,
			...
			LINE_COMMENT = 107;
	public static final String[] tokenNames = { "<INVALID>", "'abstract'", "'assert'", "'boolean'", "'break'", "'byte'",
	...
	private static final String _serializedATNSegment0 = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3m\u0b1e\4\2\t\2\4"
	...
	private static final String _serializedATNSegment1 = "\u096e\u096f\3\2\2\2\u096f\u0970\7h\2\2\u0970\u0972\7;\2\2\u0971\u0973"
