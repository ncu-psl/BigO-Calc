...
/**
 * This class provides an empty implementation of {@link CPP14Visitor}, which
...
public class CPP14BaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CPP14Visitor<T> {
	 ...
	 */
	@Override
	public T visitNoptrnewdeclarator(CPP14Parser.NoptrnewdeclaratorContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitPmexpression(CPP14Parser.PmexpressionContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitStatic_assertdeclaration(CPP14Parser.Static_assertdeclarationContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitNamednamespacedefinition(CPP14Parser.NamednamespacedefinitionContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitNamespacebody(CPP14Parser.NamespacebodyContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitAttributetoken(CPP14Parser.AttributetokenContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitAttributescopedtoken(CPP14Parser.AttributescopedtokenContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitPtrdeclarator(CPP14Parser.PtrdeclaratorContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitNoptrdeclarator(CPP14Parser.NoptrdeclaratorContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitPtroperator(CPP14Parser.PtroperatorContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitPtrabstractdeclarator(CPP14Parser.PtrabstractdeclaratorContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitNoptrabstractdeclarator(CPP14Parser.NoptrabstractdeclaratorContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitNoptrabstractpackdeclarator(CPP14Parser.NoptrabstractpackdeclaratorContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitVirtspecifierseq(CPP14Parser.VirtspecifierseqContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitVirtspecifier(CPP14Parser.VirtspecifierContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitCtorinitializer(CPP14Parser.CtorinitializerContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitRightShift(CPP14Parser.RightShiftContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitRightShiftAssign(CPP14Parser.RightShiftAssignContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitBooleanliteral(CPP14Parser.BooleanliteralContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitPointerliteral(CPP14Parser.PointerliteralContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitUserdefinedliteral(CPP14Parser.UserdefinedliteralContext ctx) {
		return visitChildren(ctx);
	}
}